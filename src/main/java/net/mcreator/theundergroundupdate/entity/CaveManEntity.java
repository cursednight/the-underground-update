...
public class CaveManEntity extends TheUndergroundUpdateModElements.ModElement {
	public static EntityType entity = null;
	@ObjectHolder("the_underground_update:entitybulletcave_man")
	public static final EntityType arrow = null;
	public CaveManEntity(TheUndergroundUpdateModElements instance) {
		super(instance, 230);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("cave_man")
						.setRegistryName("cave_man");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -14940412, -13234682, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("cave_man_spawn_egg"));
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
				.size(0.5f, 0.5f)).build("entitybulletcave_man").setRegistryName("entitybulletcave_man"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 20, 2, 6));
	}
	...
	private static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelherobrine(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("the_underground_update:textures/cave_man.png");
					}
				};
			});
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, SpiderEntity.class, false, false));
			...
			this.targetSelector.addGoal(4, new NearestAttackableTargetGoal(this, CaveSpiderEntity.class, false, false));
			this.goalSelector.addGoal(5, new MeleeAttackGoal(this, 1.2, false));
			this.goalSelector.addGoal(6, new RandomWalkingGoal(this, 1));
			this.targetSelector.addGoal(7, new HurtByTargetGoal(this));
			this.goalSelector.addGoal(8, new LookRandomlyGoal(this));
			this.goalSelector.addGoal(9, new SwimGoal(this));
			this.goalSelector.addGoal(10, new LookAtGoal(this, WorkerPenguinEntity.CustomEntity.class, (float) 20));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(ExoticLeatherItem.block, (int) (1)));
		}
	...
	public static class Modelherobrine extends EntityModel<Entity> {
