...
public class ShaleSlabBlock extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:shale_slab")
	public static final Block block = null;
	public ShaleSlabBlock(TheUndergroundUpdateModElements instance) {
		super(instance, 40);
	}
