...
public class GlowingMushroomBlock extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:glowing_mushroom")
	public static final Block block = null;
	public GlowingMushroomBlock(TheUndergroundUpdateModElements instance) {
		super(instance, 156);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("glowing_mushroom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_underground_update:glowing_mushroom"),
					configuredFeature);
		}
	}
	@SubscribeEvent
