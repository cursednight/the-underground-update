...
public class ChiseledShaleBlock extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:chiseled_shale")
	public static final Block block = null;
	public ChiseledShaleBlock(TheUndergroundUpdateModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_shale");
		}
