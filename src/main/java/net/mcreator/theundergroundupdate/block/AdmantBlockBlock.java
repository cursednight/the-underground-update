...
public class AdmantBlockBlock extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:admant_block")
	public static final Block block = null;
	public AdmantBlockBlock(TheUndergroundUpdateModElements instance) {
		super(instance, 219);
	}
