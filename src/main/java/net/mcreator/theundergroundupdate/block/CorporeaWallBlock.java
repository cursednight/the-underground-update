...
public class CorporeaWallBlock extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:corporea_wall")
	public static final Block block = null;
	public CorporeaWallBlock(TheUndergroundUpdateModElements instance) {
		super(instance, 142);
	}
