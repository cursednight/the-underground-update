...
import net.mcreator.theundergroundupdate.item.EnderiteScrapItem;
...
public class EnderiteOreBlock extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:enderite_ore")
	public static final Block block = null;
	public EnderiteOreBlock(TheUndergroundUpdateModElements instance) {
		super(instance, 164);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EnderiteScrapItem.block, (int) (1)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("the_underground_update:enderite_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_underground_update:enderite_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
