...
public class NetherDiamondBlock extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:nether_diamond")
	public static final Block block = null;
	public NetherDiamondBlock(TheUndergroundUpdateModElements instance) {
		super(instance, 60);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("the_underground_update:nether_diamond_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_underground_update:nether_diamond"),
					configuredFeature);
		}
	}
	@SubscribeEvent
