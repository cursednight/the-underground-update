...
public class AmethystBlockBlock extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:amethyst_block")
	public static final Block block = null;
	public AmethystBlockBlock(TheUndergroundUpdateModElements instance) {
		super(instance, 84);
	}
