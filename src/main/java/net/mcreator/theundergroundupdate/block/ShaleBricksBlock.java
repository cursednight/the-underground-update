...
public class ShaleBricksBlock extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:shale_bricks")
	public static final Block block = null;
	public ShaleBricksBlock(TheUndergroundUpdateModElements instance) {
		super(instance, 48);
	}
