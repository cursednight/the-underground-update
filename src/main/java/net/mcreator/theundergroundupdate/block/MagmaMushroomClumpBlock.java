...
public class MagmaMushroomClumpBlock extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:magma_mushroom_clump")
	public static final Block block = null;
	public MagmaMushroomClumpBlock(TheUndergroundUpdateModElements instance) {
		super(instance, 158);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("magma_mushroom_clump"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_underground_update:magma_mushroom_clump"),
					configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("magma_mushroom_clump");
		}
