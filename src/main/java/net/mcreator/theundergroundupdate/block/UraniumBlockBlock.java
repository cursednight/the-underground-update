...
public class UraniumBlockBlock extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:uranium_block")
	public static final Block block = null;
	public UraniumBlockBlock(TheUndergroundUpdateModElements instance) {
		super(instance, 65);
	}
