...
public class LesserTopazBlockBlock extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:lesser_topaz_block")
	public static final Block block = null;
	public LesserTopazBlockBlock(TheUndergroundUpdateModElements instance) {
		super(instance, 189);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lesser_topaz_block");
		}
