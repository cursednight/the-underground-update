...
public class EnderiteBlockBlock extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:enderite_block")
	public static final Block block = null;
	public EnderiteBlockBlock(TheUndergroundUpdateModElements instance) {
		super(instance, 165);
	}
