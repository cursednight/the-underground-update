...
public class NetherGoldBlock extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:nether_gold")
	public static final Block block = null;
	public NetherGoldBlock(TheUndergroundUpdateModElements instance) {
		super(instance, 62);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.GOLD_INGOT, (int) (3)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("the_underground_update:nether_gold_match"),
			...
			event.getRegistry().register(feature.setRegistryName("nether_gold"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_underground_update:nether_gold"), configuredFeature);
		}
	}
	@SubscribeEvent
