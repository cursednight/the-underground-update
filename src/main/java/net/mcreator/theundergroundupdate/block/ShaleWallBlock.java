...
public class ShaleWallBlock extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:shale_wall")
	public static final Block block = null;
	public ShaleWallBlock(TheUndergroundUpdateModElements instance) {
		super(instance, 39);
	}
