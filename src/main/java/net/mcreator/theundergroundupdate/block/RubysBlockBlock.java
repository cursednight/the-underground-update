...
public class RubysBlockBlock extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:rubys_block")
	public static final Block block = null;
	public RubysBlockBlock(TheUndergroundUpdateModElements instance) {
		super(instance, 100);
	}
