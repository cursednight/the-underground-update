...
public class UraniumOreBlock extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:uranium_ore")
	public static final Block block = null;
	public UraniumOreBlock(TheUndergroundUpdateModElements instance) {
		super(instance, 64);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("the_underground_update:uranium_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_underground_update:uranium_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
