...
public class AmethystOreBlock extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:amethyst_ore")
	public static final Block block = null;
	public AmethystOreBlock(TheUndergroundUpdateModElements instance) {
		super(instance, 83);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("the_underground_update:amethyst_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_underground_update:amethyst_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
