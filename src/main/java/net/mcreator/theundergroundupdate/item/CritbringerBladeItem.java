...
public class CritbringerBladeItem extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:critbringer_blade")
	public static final Item block = null;
	public CritbringerBladeItem(TheUndergroundUpdateModElements instance) {
		super(instance, 224);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("critbringer_blade");
		}
