...
public class UraniumIngotItem extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:uranium_ingot")
	public static final Item block = null;
	public UraniumIngotItem(TheUndergroundUpdateModElements instance) {
		super(instance, 63);
	}
