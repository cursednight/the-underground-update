...
public class MallachiteIngotItem extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:mallachite_ingot")
	public static final Item block = null;
	public MallachiteIngotItem(TheUndergroundUpdateModElements instance) {
		super(instance, 1);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("mallachite_ingot");
		}
