...
public class RefinedRubyItem extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:refined_ruby")
	public static final Item block = null;
	public RefinedRubyItem(TheUndergroundUpdateModElements instance) {
		super(instance, 159);
	}
