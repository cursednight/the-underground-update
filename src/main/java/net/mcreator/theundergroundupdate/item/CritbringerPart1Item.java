...
public class CritbringerPart1Item extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:critbringer_part_1")
	public static final Item block = null;
	public CritbringerPart1Item(TheUndergroundUpdateModElements instance) {
		super(instance, 212);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("critbringer_part_1");
		}
