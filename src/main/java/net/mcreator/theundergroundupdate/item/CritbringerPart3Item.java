...
public class CritbringerPart3Item extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:critbringer_part_3")
	public static final Item block = null;
	public CritbringerPart3Item(TheUndergroundUpdateModElements instance) {
		super(instance, 214);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("critbringer_part_3");
		}
