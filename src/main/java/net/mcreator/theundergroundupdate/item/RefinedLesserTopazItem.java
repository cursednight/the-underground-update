...
public class RefinedLesserTopazItem extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:refined_lesser_topaz")
	public static final Item block = null;
	public RefinedLesserTopazItem(TheUndergroundUpdateModElements instance) {
		super(instance, 210);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("refined_lesser_topaz");
		}
