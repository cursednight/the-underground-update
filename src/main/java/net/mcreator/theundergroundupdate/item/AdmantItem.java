...
public class AdmantItem extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:admant")
	public static final Item block = null;
	public AdmantItem(TheUndergroundUpdateModElements instance) {
		super(instance, 217);
	}
