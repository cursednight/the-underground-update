...
public class MalachiteShardItem extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:malachite_shard")
	public static final Item block = null;
	public MalachiteShardItem(TheUndergroundUpdateModElements instance) {
		super(instance, 34);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("malachite_shard");
		}
