...
public class PenguinFeatherItem extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:penguin_feather")
	public static final Item block = null;
	public PenguinFeatherItem(TheUndergroundUpdateModElements instance) {
		super(instance, 228);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("penguin_feather");
		}
