...
public class RefinedobsidianingotItem extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:refinedobsidianingot")
	public static final Item block = null;
	public RefinedobsidianingotItem(TheUndergroundUpdateModElements instance) {
		super(instance, 255);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("refinedobsidianingot");
		}
