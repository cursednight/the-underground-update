...
public class BaseGoldAxeItem extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:base_gold_axe")
	public static final Item block = null;
	public BaseGoldAxeItem(TheUndergroundUpdateModElements instance) {
		super(instance, 73);
	}
