...
public class AmethystItem extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:amethyst")
	public static final Item block = null;
	public AmethystItem(TheUndergroundUpdateModElements instance) {
		super(instance, 82);
	}
