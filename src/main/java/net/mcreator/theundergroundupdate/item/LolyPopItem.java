...
public class LolyPopItem extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:loly_pop")
	public static final Item block = null;
	public LolyPopItem(TheUndergroundUpdateModElements instance) {
		super(instance, 186);
	}
