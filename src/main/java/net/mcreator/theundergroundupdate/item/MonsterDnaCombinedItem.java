...
public class MonsterDnaCombinedItem extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:monster_dna_combined")
	public static final Item block = null;
	public MonsterDnaCombinedItem(TheUndergroundUpdateModElements instance) {
		super(instance, 227);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("monster_dna_combined");
		}
