...
public class EnderiteScrapItem extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:enderite_scrap")
	public static final Item block = null;
	public EnderiteScrapItem(TheUndergroundUpdateModElements instance) {
		super(instance, 184);
	}
