...
public class CrystalOfDeathItem extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:crystal_of_death")
	public static final Item block = null;
	public CrystalOfDeathItem(TheUndergroundUpdateModElements instance) {
		super(instance, 243);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("crystal_of_death");
		}
