...
public class AdmantdustItem extends TheUndergroundUpdateModElements.ModElement {
	@ObjectHolder("the_underground_update:admantdust")
	public static final Item block = null;
	public AdmantdustItem(TheUndergroundUpdateModElements instance) {
		super(instance, 252);
	}
